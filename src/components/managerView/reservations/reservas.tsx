    ...
    return (
        <div>
            <div className="d-flex justify-content-end align-items-center">
                <h1 className="me-3">Editar Menú Reservas</h1><button className="" onClick={showEditMenu}><img className="smallImg" src="/images/edit.png" alt="Edit icon"></img></button>
            </div>
                { showEditOptions ? 
                    <div className="row d-flex justify-content-around my-3">
                        <button className='col-md-3 m-auto addNewTableButton' onClick={showCreateTableWindow}>Crear nueva mesa</button>
                        <button className='col-md-3 m-auto addNewTableButton' onClick={showDeleteTableWindow}>Eliminar mesa</button>
                        
                        { newTableWindow ? <NewTableWindow setVisibility={showCreateTableWindow} /> : null }
                        { showDeleteOptions ? <DeleteTableWindow setVisibility={showDeleteTableWindow} /> : null }
                    </div>
                : null }
