        ...
        <div className={'row col-md-6 p-3 popup-window ' + fadeInAnimation}>
            ...
            <div className="row d-flex justify-content-around" id='thirdRow'>
                <form action="" onSubmit={(event) => onSubmit(event)}>
                    <input className="col-lg-5"  onChange={(event) => setNewCategoryName(event.target.value)} type='text' />
                    <button className="col-lg-5 btn-success" type='submit' >Crear nueva categoría</button>
                </form>
            </div>
        </div>
    )
